...
<body>
	<div id="container">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="${path}/memo/selectMemoAll.do">MemoList</a>
						</li>
						
						<li class="nav-item">
							<a class="nav-link" href="${path}/board/selectBoardAll.do">게시판</a>
						</li>
					</ul>
				<c:if test="${loginMember!=null}">
					<span>
						<a href="${path}/member/mypage.do?userId=${loginMember.userId}"> <!-- 쿼리스트링으로 값 넘기기 -->
					...
					<button class="btn btn-outline-dark my-2 my-sm-0" onclick="location.replace('${path}/member/logout.do');">
						로그아웃
					</button>
				...
				<c:if test="${loginMember==null }">
					...
					&nbsp;
					<button class="btn btn-outline-primary my-2 my-sm-0" onclick="location.href='${path}/member/enrollMember.do'">
						회원가입
					</button>
				</c:if>
		...
		<script>
			const chattingOpen=()=>{
				open("${path}/chattingpage","_blank","width=400,height=500"); // 새창열기
			}
		</script>
